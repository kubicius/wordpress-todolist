    ...
    <div class="todolist__container">
        ...
        <div class="todolist__list" id="todolist_<?php echo $todolist['ID'] ?>">
            ...
            <div class="todolist__title--edit"  style="display: none;">
                <input class="todolist__title-input" type="text" value="<?php echo $todolist['name'] ?>" maxlength="128">
            </div>
            ...
            <div class="todolist__task" id="todolist_task_<?php echo $task['ID'] ?>">
                ...
                <input type="text" class="todolist__task-input--edit" value="<?php echo $task['description'] ?>" style="display:none;" maxlength="1024">
            ...
            <div class="todolist__task todolist__task--add">
                <input type="text" placeholder="Add task" class="todolist__task-input--add" maxlength="1024">
            </div>
        </div>
        <?php endforeach; ?>
        <div class="todolist__list todolist__list--new">
            ...
            <div class="todolist__title--edit"  style="display: none;">
                <input class="todolist__title-input--new" type="text" placeholder="New list title" maxlength="128">
                <input class="todolist__title-input" type="text" placeholder="Title" style="display: none;" maxlength="128">
            </div>
            <div class="todolist__task todolist__task--pattern" style="display:none;">
                ...
                <input type="text" class="todolist__task-input--edit" style="display:none;" maxlength="1024">
                <span class="todolist__task-button--edit dashicons dashicons-edit-large"></span>
                <span class="todolist__task-button--delete dashicons dashicons-trash"></span>
            </div>
            <div class="todolist__task todolist__task--add" style="display: none;" maxlength="1024">
